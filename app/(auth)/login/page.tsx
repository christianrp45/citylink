...
export default function Page() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({ type: "error", description: "Login com Google não disponível. Configure AUTH_GOOGLE_ID e AUTH_GOOGLE_SECRET." });
      ...
      <div className="flex w-full max-w-md flex-col gap-8 overflow-hidden rounded-2xl px-4 pb-10">
        ...
        <div className="flex flex-col gap-3 px-4 sm:px-16">
          <button
            ...
            className="flex items-center justify-center gap-3 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 transition disabled:opacity-60"
          >
            {googleLoading ? (
